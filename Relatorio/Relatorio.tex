...
\newglossaryentry{proj2}{name = $proj_{2}(p)$, description={Segundo elemento do par ordenado $p$}}

\newglossaryentry{proj1}{name = $proj_{1}(p)$, description={Primeiro elemento do par ordenado $p$}}
